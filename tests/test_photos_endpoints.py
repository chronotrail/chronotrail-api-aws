...
class TestPhotoUpload:
    ...
    def test_upload_photo_success(self, client, mock_db, test_user, test_image_file):
    ...
    def test_upload_photo_file_too_large(
        self, client, mock_db, test_user, large_image_file
    ):
        ...
        with (
            ...
            response = client.post(
                "/api/v1/photos", files={"file": (filename, file_content, content_type)}
            )
    ...
    def test_upload_photo_invalid_timestamp(
        self, client, mock_db, test_user, test_image_file
    ):
