...
class TestMediaFileRepository:
    ...
    async def test_get_by_user_with_file_type_filter(self, repository, mock_db, sample_user_id):
    ...
    async def test_get_by_user_with_date_range(self, repository, mock_db, sample_user_id):
    ...
    async def test_get_by_file_path_success(self, repository, mock_db, sample_media_file):
    ...
    async def test_count_by_user_with_file_type(self, repository, mock_db, sample_user_id):
    ...
    async def test_get_recent_by_user_success(self, repository, mock_db, sample_user_id):
    ...
    async def test_pagination_support(self, repository, mock_db, sample_user_id):
        ...
        mock_result = Mock()
        mock_result.scalars.return_value.all.return_value = media_files[:3]  # First 3 items
        mock_db.execute = AsyncMock(return_value=mock_result)
    ...
    async def test_database_error_handling(self, repository, mock_db, sample_media_file):
    ...
    async def test_get_by_user_and_id_success(self, repository, mock_db, sample_media_file):
    ...
    async def test_update_file_path_success(self, repository, mock_db, sample_media_file):
