...
class TestVoiceUpload:
    ...
    def test_upload_voice_success(
        ...
        with patch("app.services.usage.UsageService.check_subscription_validity", return_value=test_user), \
             ...
             patch("app.aws.transcription.transcription_service.process_voice") as mock_transcription, \
            ...
            from app.models.schemas import ProcessedVoice, ContentType
    ...
    def test_upload_voice_file_too_large(
        ...
        with patch("app.services.usage.UsageService.check_subscription_validity", return_value=test_user), \
             patch("app.middleware.usage_validation.UsageService.check_daily_content_limit", return_value=None), \
             patch("app.api.v1.endpoints.voice.validate_file_size") as mock_validate_file_size, \
             patch("app.aws.storage.file_storage_service.upload_file") as mock_storage:
