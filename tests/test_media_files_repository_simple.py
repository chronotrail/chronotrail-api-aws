...
class TestMediaFileRepositorySimple:
    ...
    async def test_create_media_file_success(self, repository, mock_db, sample_user_id, sample_media_create):
    ...
    async def test_get_multi_success(self, repository, mock_db):
        ...
        media_files = [
            MediaFile(id=uuid4(), user_id=uuid4(), file_type="photo", file_path="1.jpg", original_filename="1.jpg", timestamp=datetime.utcnow()),
            MediaFile(id=uuid4(), user_id=uuid4(), file_type="video", file_path="2.mp4", original_filename="2.mp4", timestamp=datetime.utcnow())
        ]
