...
from app.services.query import QueryProcessingService, QueryIntent, QueryFilter
...
class TestQueryProcessingServiceSimple:
    ...
    @pytest.mark.asyncio
    async def test_process_query_basic_success(self, query_service, mock_embedding_service, test_user, mock_db):
