...
class TestLLMService:
    ...
    def test_generate_response_anthropic(self, mock_get_client, llm_service, mock_context_items):
    ...
    @patch('app.aws.llm.get_bedrock_client')
    def test_generate_response_error(self, mock_get_client, llm_service, mock_context_items):
    ...
    @patch('app.aws.llm.get_bedrock_client')
    def test_generate_response_fallback_model(self, mock_get_client, llm_service, mock_context_items):
...
class TestLLMServiceAsync:
    ...
    @pytest.mark.asyncio
    @patch('app.aws.llm.get_async_bedrock_client')
    async def test_generate_response_async_error(self, mock_get_client, llm_service, mock_context_items):
