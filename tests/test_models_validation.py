...
class TestLocationVisitModels:
    ...
    def test_location_visit_invalid_coordinates(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            LocationVisitCreate(
                longitude=200.0, latitude=37.7749, visit_time=datetime.utcnow()
            )
        ...
        with pytest.raises(ValidationError) as exc_info:
            LocationVisitCreate(
                longitude=-122.4194, latitude=100.0, visit_time=datetime.utcnow()
            )
    ...
    def test_location_visit_future_time_validation(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            LocationVisitCreate(
                longitude=-122.4194, latitude=37.7749, visit_time=future_time
            )
    ...
    def test_location_visit_update_validation(self):
        ...
        update = LocationVisitUpdate(
            description="Updated description", names=["New Name"]
        )
...
class TestTextNoteModels:
    ...
    def test_text_note_create_minimal(self):
        ...
        data = {"text_content": "Minimal note", "timestamp": datetime.utcnow()}
        note = TextNoteCreate(**data)
    ...
    def test_text_note_empty_content(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            TextNoteCreate(text_content="", timestamp=datetime.utcnow())
    ...
    def test_text_note_content_too_long(self):
        ...
        with pytest.raises(ValidationError) as exc_info:
            TextNoteCreate(text_content=long_content, timestamp=datetime.utcnow())
    ...
    def test_text_note_future_timestamp(self):
        ...
        future_time = datetime.utcnow() + timedelta(hours=1)
        with pytest.raises(ValidationError) as exc_info:
            TextNoteCreate(text_content="Test note", timestamp=future_time)
...
class TestQueryModels:
    ...
    def test_query_request_valid(self):
        ...
        request = QueryRequest(
            query="What did I do yesterday?", session_id="test-session-123"
        )
...
class TestUsageModels:
    ...
    def test_usage_stats_valid(self):
        ...
        stats = UsageStats(
            ...
            media_files_count=3,
            queries_count=10,
            daily_limits={"text_notes": 10, "media_files": 10, "queries": 50},
        )
    ...
    def test_subscription_info_valid(self):
        ...
        info = SubscriptionInfo(
            ...
            daily_limits={"content": 10, "queries": 50},
...
class TestErrorResponseModel:
    ...
    def test_error_response_minimal(self):
        ...
        error = ErrorResponse(error="NotFound", message="Resource not found")
...
class TestModelSerialization:
    ...
    def test_location_visit_json_serialization(self):
        ...
        assert (
            json_data["longitude"] == visit.longitude
        )  # Decimal is preserved in model_dump
    ...
    def test_model_field_aliases(self):
        ...
        note_data = {
            k: v for k, v in data.items() if k in ["text_content", "timestamp"]
        }
