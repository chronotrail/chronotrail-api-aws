...
from app.models.schemas import User, UserCreate, UserUpdate, TokenResponse, RefreshTokenRequest
from app.db.database import get_user_by_oauth, create_user, update_user, get_user_by_id, get_async_db
            ...
            if (display_name and display_name != existing_user.display_name) or \
               (profile_picture and profile_picture != existing_user.profile_picture_url):
                ...
                user_update = UserUpdate(
                    ...
                    profile_picture_url=profile_picture or existing_user.profile_picture_url
                )
...
async def get_current_active_user(
    ...
    if (current_user.subscription_tier in ["premium", "pro"] and 
