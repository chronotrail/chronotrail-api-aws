...
class EmbeddingService:
    ...
    def ensure_index_exists(self) -> bool:
        ...
        try:
            ...
            opensearch_client.indices.create(
                index=self.index_name, body=OPENSEARCH_MAPPING
            )
        ...
        try:
            ...
            query = {
                ...
                "query": {
                    "bool": {
                        ...
                        "should": [
                            {"knn": {"content_vector": {"vector": vector, "k": k}}}
                        ],
            ...
            if location_filter:
                ...
                if "names" in location_filter:
                    query["query"]["bool"]["must"].append(
                        {"terms": {"location.names": location_filter["names"]}}
                    )
            ...
            # Execute search
            response = opensearch_client.search(index=self.index_name, body=query)
    ...
    def delete_user_documents(self, user_id: Union[str, UUID]) -> int:
        ...
        try:
            ...
            logger.info(
                f"Deleted {deleted} documents for user {user_id} from {self.index_name}"
            )
            return deleted
