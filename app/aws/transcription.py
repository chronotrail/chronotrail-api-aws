...
from app.aws.utils import generate_s3_key, ALLOWED_AUDIO_TYPES
...
class TranscriptionService:
    ...
    async def wait_for_transcription_job(self, job_name: str, timeout: int = 300) -> Dict[str, Any]:
        """
    ...
    def extract_transcript_text(self, transcript_data: Dict[str, Any]) -> Tuple[str, float]:
        """
    ...
    async def transcribe_audio_file(
        ...
        try:
            ...
            # Download transcript
            transcript_uri = completed_job.get('Transcript', {}).get('TranscriptFileUri')
