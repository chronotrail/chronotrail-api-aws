...
class Settings(BaseSettings):
    ...
    DATABASE_URL: str = os.getenv(
        "DATABASE_URL", "postgresql://user:password@localhost/chronotrail"
    )
    ...
    AWS_ENDPOINT_URL: Optional[str] = os.getenv("AWS_ENDPOINT_URL")  # For LocalStack
    ...
    OPENSEARCH_USE_IAM_AUTH: bool = (
        os.getenv("OPENSEARCH_USE_IAM_AUTH", "").lower() == "true"
    )
