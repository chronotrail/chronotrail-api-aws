...
@router.post(
    ...
    responses={
        201: {"description": "Location visit created successfully", "model": LocationVisit},
...
@router.get(
    ...
    responses={
        200: {"description": "Location visits retrieved successfully", "model": LocationVisitsResponse},
        401: {"description": "Authentication required", "model": ErrorResponse},
        403: {"description": "Query date range exceeds subscription limits", "model": ErrorResponse},
...
@router.put(
    ...
    responses={
        200: {"description": "Location visit updated successfully", "model": LocationVisit},
        400: {"description": "Invalid request data", "model": ErrorResponse},
        401: {"description": "Authentication required", "model": ErrorResponse},
...
@router.get(
    ...
    responses={
        200: {"description": "Location visit retrieved successfully", "model": LocationVisit},
        401: {"description": "Authentication required", "model": ErrorResponse},
        403: {"description": "Access denied to this resource", "model": ErrorResponse},
        404: {"description": "Location visit not found", "model": ErrorResponse}
    }
