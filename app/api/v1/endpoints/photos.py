...
@router.post(
    ...
    responses={
        201: {"description": "Photo uploaded and processed successfully", "model": FileUploadResponse},
...
async def upload_photo(
    ...
    timestamp: Optional[str] = Form(None, description="ISO timestamp when photo was taken"),
    ...
    try:
        ...
        try:
            ...
            if processed_text and processed_text.strip() and processed_text.strip() != "No text or recognizable content found in image":
                ...
                content_type = ContentType.IMAGE_TEXT if processed_result.extracted_text else ContentType.IMAGE_DESC
                ...
                try:
                    ...
                    logger.error(f"Failed to store photo content in vector database: {str(embedding_error)}")
        ...
        return FileUploadResponse(
            ...
            message=f"Photo uploaded and processed successfully. {processed_text[:100]}..." if len(processed_text) > 100 else processed_text,
